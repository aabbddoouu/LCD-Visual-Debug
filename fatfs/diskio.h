...
DSTATUS SD_SDIO_disk_initialize(void);
DSTATUS SD_disk_initialize(void);
DSTATUS USB_disk_initialize(void);
DSTATUS SDRAM_disk_initialize(void);
DSTATUS SPI_FLASH_disk_initialize(void);

DSTATUS SD_SDIO_disk_status(void);
DSTATUS SD_disk_status(void);
DSTATUS USB_disk_status(void);
DSTATUS SDRAM_disk_status(void);
DSTATUS SPI_FLASH_disk_status(void);

DRESULT SD_SDIO_disk_ioctl(BYTE cmd, void *buff);
DRESULT SD_disk_ioctl(BYTE cmd, void *buff);
DRESULT USB_disk_ioctl(BYTE cmd, void *buff);
DRESULT SDRAM_disk_ioctl(BYTE cmd, void *buff);
DRESULT SPI_FLASH_disk_ioctl(BYTE cmd, void *buff);

DRESULT SD_SDIO_disk_read(BYTE *buff, DWORD sector, UINT count);
DRESULT SD_disk_read(BYTE *buff, DWORD sector, UINT count);
DRESULT USB_disk_read(BYTE *buff, DWORD sector, UINT count);
DRESULT SDRAM_disk_read(BYTE *buff, DWORD sector, UINT count);
DRESULT SPI_FLASH_disk_read(BYTE *buff, DWORD sector, UINT count);

DRESULT SD_SDIO_disk_write(const BYTE *buff, DWORD sector, UINT count);
...
DRESULT SDRAM_disk_write(const BYTE *buff, DWORD sector, UINT count);
DRESULT SPI_FLASH_disk_write(const BYTE *buff, DWORD sector, UINT count);
